...
struct RSAManaged_t649;

#include "mscorlib_System_Object.h"

// Mono.Security.Protocol.Tls.TlsClientSettings
struct  TlsClientSettings_t698  : public Object_t
{
	...
	X509CertificateCollection_t729 * ___certificates_1;
