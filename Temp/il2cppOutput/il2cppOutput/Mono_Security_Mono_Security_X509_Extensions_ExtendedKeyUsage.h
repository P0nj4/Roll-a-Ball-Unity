...
struct  ExtendedKeyUsageExtension_t671  : public X509Extension_t665
{
	// System.Collections.ArrayList Mono.Security.X509.Extensions.ExtendedKeyUsageExtension::keyPurpose
	ArrayList_t630 * ___keyPurpose_3;
};
struct ExtendedKeyUsageExtension_t671_StaticFields{
	...
	Dictionary_2_t161 * ___U3CU3Ef__switchU24map14_4;
};
