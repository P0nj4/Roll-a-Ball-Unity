...
struct  ClientSessionInfo_t693  : public Object_t
{
	...
	ByteU5BU5D_t599* ___sid_4;
	// System.Byte[] Mono.Security.Protocol.Tls.ClientSessionInfo::masterSecret
	ByteU5BU5D_t599* ___masterSecret_5;
};
struct ClientSessionInfo_t693_StaticFields{
